      ...
      <ul className="sidebar-nav">
        ...
        <li className="nav-item">
          ...
          <ul className="nav-group-items ms-4">
            <li className="nav-item">
              <Link to="inventario/producto" className="nav-link">Producto</Link>
            </li>
            <li className="nav-item">
              <Link to="inventario/familia" className="nav-link">Familia</Link>
            </li>
            <li className="nav-item">
              <Link to="inventario/subfamilia" className="nav-link">Subfamilia</Link>
            </li>
          </ul>
        </li>
